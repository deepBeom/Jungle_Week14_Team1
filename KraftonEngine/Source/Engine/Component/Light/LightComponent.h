...
protected:
	...
	UPROPERTY(Edit, Save, Category="Shadow", DisplayName="Shadow Bias", Min=0.0f, Max=0.2f, Speed=0.0001f)
	...
	UPROPERTY(Edit, Save, Category="Shadow", DisplayName="Shadow Normal Bias", Min=0.0f, Max=0.2f, Speed=0.0001f)
