return {
    ...
    entries = {
        ...
        },
        {
            ...
            speaker = "MCCURSON",
            text = "반투스가 뭘 하는지는 알아?",
            text_en = "Did you actually know what VANTUS does.",6
            image = "",
            font = "Pretendard",
            duration = 3.4
        },
        ...
        },
        {
            ...
            text_en = "Data drive auto-playing...",
            image = "",
            font = "Pretendard",
            duration = 2.4
        },
        {
            ...
            speaker = "SYSTEM",
            text = "LANCER 발사 승인 문서 확인됨 - 서명: DRAKE, OSUN",
            text_en = "LANCER launch authorization confirmed - Signed: DRAKE, OSUN",
            image = "",
            font = "Pretendard",
            duration = 3.6
        },
        {
            ...
            speaker = "SYSTEM",
            text = "LANCER 플랫폼 접근 시도 - 권한 없음",
            text_en = "LANCER platform access attempt - Authorization denied",
            image = "",
            font = "Pretendard",
            duration = 3.0
        },
